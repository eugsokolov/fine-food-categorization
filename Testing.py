...
reviews_train = reviews_preprocessed_topwords[0:num_train_reviews]
reviews_train_labels = scores_posneg[0:num_train_reviews]

reviews_test = reviews_preprocessed_topwords[num_train_reviews::]
